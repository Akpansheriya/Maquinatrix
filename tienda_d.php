        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav-migas">
                    ...
                    <li class="font-family-Roboto-Regular"> /
                        <?= ($tpublicacion == '2') ? 'Comprar' : ' Arrendar'; ?>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="busqueda">
                    <form>
                        ...
                        <p class="titulo-tienda">
                            <a href="#" onclick="filtroFooter('1')"
                                class="font-family-Roboto-Medium mb-3 <?= ($tpublicacion == '1') ? 'activo' : ''; ?>">Arrendar</a>
                            <a href="#" onclick="filtroFooter('2')"
                                class="font-family-Roboto-Medium mb-3 <?= ($tpublicacion == '2') ? 'activo' : ''; ?>">Comprar</a>
                        </p>
                        <div class="formulario-busqueda">
                            <div class="form-group">
                                <input type="text" name="buscar" id="buscar" value="<?= $search ?>"
                        ...
                        <div class="mt-5">
                            <button type="button" onclick="buscarTienda('<?= $tpublicacion ?>');"
                                class="btn-filtros font-family-Roboto-Medium">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <p class="titulo-tienda text-right" id="">
                            ...
                            <a href="#"
                                onclick="filtrotienda('<?= $tpublicacion ?>','<?= $categoria ?>','price-min=1','<?= $search ?>')"
                                id="price-min"
                                class="font-family-Roboto-Medium mb-3 <?= ($price_min == '1') ? 'activo' : ''; ?>">Precio
                                más bajo primero</a>
                            <a href="#"
                                onclick="filtrotienda('<?= $tpublicacion ?>','<?= $categoria ?>','price-max=1','<?= $search ?>')"
                                id="price-max"
                                class="font-family-Roboto-Medium mb-3 <?= ($price_max == '1') ? 'activo' : ''; ?>">Precio
                                más alto primero</a>
                        ...
                        <div class="all">
                            ...
                            if ($count_pub > 0) {
                                foreach ($currentRows as $pub) { ?>
                                    <a
                                        href="detalle.php?typep=<?= $tpublicacion ?>&id=<?= $pub['id_product'] ?>&<?= ($tpublicacion == '2') ? 'comprar' : ' arrendar'; ?>">
                                            ...
                                            <div class="box-description w-100">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <h3 class="mb-3">
                                                            <strong class="font-family-Roboto-Bold">
                                                                <?= isset($pub['product_details']["price"]) ? $pub['product_details']["price"] : '0' ?>
                                                            </strong>
                                                        </h3>
                                                    </div>
                                                    <div
                                                        class="col-md-12 mini-detalles d-flex align-items-center justify-content-between">
                                                        <div class="ubicacion font-family-Roboto-Regular">
                                                            <i class="fal fa-map-marker-alt"></i>
                                                            <?= $pub['location'] ?>
                                                        </div>
                                                        <a onclick="whats('<?= $tpublicacion ?>','<?= $pub['id_product'] ?>','<?= $pub['title'] ?>','<?= $url_publi ?>')"
                                                            href="#" class="btn-contacto font-family-Roboto-Medium">
                                                            <i class="fab fa-whatsapp"></i> <b
                                                                class="icono_mobile">Contactar</b>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="box-description">
                                        <div class="row">
                                            ...
                                            <div
                                                ...
                                                <a href="https://api.whatsapp.com/send?phone=<?= $contact ?>&text=¡Hola! Estoy interesado en el anuncio# <?= $detalle['$id'] ?> que vi en el  <?= $detalle['title'] ?> Maquinatrix."
                                                    class="btn-contacto font-family-Roboto-Medium">
                    ...
                    if ($count_pub > 0) { ?>
                        <div class="col-md-12 mt-5">
                            <ul class="align-items-center font-family-Inter-Regular justify-content-end m-auto pagination">
                                <li class="page-item"><a class="page-link" href="tienda.php?page=<?= $currentPage - 1 ?>"
                                        <?= $param ?>>Anterior</a></li>
                                <?php
                                ...
                                <li class="page-item"><a class="page-link"
                                        href="tienda.php?page=<?= $currentPage + 1 ?><?= $param ?>">Siguiente</a></li>
                            </ul>
                        </div>
                    <?php } ?>
                </div>
